...
//    void set_get_ice_speed(std::function<QPoint(void)>);
//    void set_get_fire_speed(std::function<QPoint(void)>);


    int curFrame; //用于绘制动图，记录帧数
...
protected:
    ...
    void wheelEvent(QWheelEvent *event) override;             //鼠标滑轮
